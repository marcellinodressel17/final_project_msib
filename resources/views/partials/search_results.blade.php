                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fas fa-clock"></i><span
                                    class="ps-1">{{ \Carbon\Carbon::parse($beasiswa->waktu)->format('d-m-Y') }}</span>
                            </li>
                            </li>
                            <li class="list-group-item">
